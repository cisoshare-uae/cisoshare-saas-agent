...
CREATE INDEX IF NOT EXISTS idx_document_comments_author ON document_comments(created_by);
...
DROP TRIGGER IF EXISTS ensure_single_latest_version ON documents;
...
DROP TRIGGER IF EXISTS track_template_usage ON documents;
