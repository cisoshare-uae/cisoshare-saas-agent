 ...
 */
exports.internalEmployeesRouter.get("/list", internalAuth_1.requireInternalAuth, async (req, res) => {
 ...
 */
exports.internalEmployeesRouter.get("/:id", internalAuth_1.requireInternalAuth, async (req, res) => {
    const reqId = req.reqId;
    const { actorId, actorEmail, actorRole, actorIp } = getActorContext(req);
    try {
 ...
 */
exports.internalEmployeesRouter.post("/", internalAuth_1.requireInternalAuth, async (req, res) => {
    const reqId = req.reqId;
    const { actorId, actorEmail, actorRole, actorIp } = getActorContext(req);
    try {
        const { tenant_id, employee_id, full_name, email, phone, national_id, nationality, date_of_birth, department, position, hire_date, employment_type, employment_status, manager_id } = req.body || {};
 ...
 */
exports.internalEmployeesRouter.put("/:id", internalAuth_1.requireInternalAuth, async (req, res) => {
    const reqId = req.reqId;
    const { actorId, actorEmail, actorRole, actorIp } = getActorContext(req);
    try {
        const id = String(req.params.id || "").trim();
 ...
 */
exports.internalEmployeesRouter.delete("/:id", internalAuth_1.requireInternalAuth, async (req, res) => {
    const reqId = req.reqId;
    const { actorId, actorEmail, actorRole, actorIp } = getActorContext(req);
    try {
        const id = String(req.params.id || "").trim();
